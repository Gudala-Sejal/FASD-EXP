...
public class JWTManager {
	...
	public final String SECRET_KEY ="eyJhbGciOiJIUzM4NCJ9.eyJ1c2VybmFtZSI6IlcvMEV5R3FWbHpjMFZVQW5DQXc0UVE9PSIsImlhdCI6MTc3MTgzNzA2OSwiZXhwIjoxNzcxOTIzNDY5fQ.lzdcyXScp9ppz2m3E-HdZR7oTM2NCqZ8vApMS6oqHq9Uq3on8MuZBmpve_TVqK5B";
	...
	public String encryptData(String data)
	{
		try
		{
			...
			byte[] keyBytes = MD5.digest("DINESHGD".getBytes());
